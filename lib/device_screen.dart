...
class _DeviceScreenState extends State<DeviceScreen> {
  ...
  Future<bool> connect() async {
    ...
    /*
      Set timeout to 15 seconds (15000 ms) and turn off autoconnect
      ...
      if (c.properties.notify) {
        ...
        if (notifyDatas.containsKey(c.uuid.toString())) {
          ...
          if (notifyDatas[c.uuid.toString()]!.isNotEmpty) {
            dynamic dataChar = notifyDatas[c.uuid.toString()];
            print(c);
            print('\n\n\n\n\n\n\n\n\n\n\n');
            print(c.properties.notify);
            data = String.fromCharCodes(dataChar).replaceAll('&', '\n').replaceAll('=', ' = ');
